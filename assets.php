...
function github_theme_update_row( $theme_key, $theme ) {
	...
	*/  
	...
	if( isset($r['error']) ){
		...
		printf( __('There is a new version of %1$s available. <a href="%2$s" target="blank" title="%3$s">View version %4$s details</a> or <a href="%5$s">update automatically</a>.'), $theme['Name'], esc_url($details_url), esc_attr($theme['Name']), $r['new_version'], wp_nonce_url( self_admin_url('update.php?action=upgrade-github-theme&theme=') . $theme_key, 'upgrade-theme_' . $theme_key) );
